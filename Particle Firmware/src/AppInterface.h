...
const commandSet commandList[] = {
  ...
  {"flushCycles", &settings.flushCycles, false, NULL},
  {"flushFinishDelay", &settings.flushFinishDelay, false, NULL},
  ...
  {"purgeCounts", &settings.purgeCounts, false, NULL},
  ...
  {"washCounts", &settings.washCounts, false, NULL},
  {"washCycles", &settings.washCycles, false, NULL},
